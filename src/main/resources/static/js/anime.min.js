...
(function (t, q) {
    ...
    var t = {
            ...
            update: void 0,
            complete: void 0
        }, q = "translateX translateY translateZ rotate rotateX rotateY rotateZ scale scaleX scaleY scaleZ skewX skewY".split(" "), x, f = {
            arr: function (a) {
        ...
        S = function (a) {
            ...
            if (0 == c)c = d = b = d; else var e = .5 > d ? d * (1 + c) : d + c - d * c, h = 2 * d - e, c = a(h, e, b + 1 / 3), d = a(h, e, b), b = a(h, e, b - 1 / 3);
            ...
            var b = /-?\d*\.?\d+/g;
            return {
                original: a, numbers: y(a).match(b) ?
                    y(a).match(b).map(Number) : [0], strings: y(a).split(b)
            }
        }, U = function (a, b, c) {
            ...
            a.forEach(function (d, e) {
                ...
                return b.forEach(function (b) {
                    ...
                    if (l) {
                        var m;
                        m = b.name;
                        var g = b.value, g = r(f.fnc(g) ? g(h, e) : g);
                        m = {from: 1 < g.length ? g[0] : J(h, m), to: 1 < g.length ? g[1] : g[0]};
                        g = A(b);
                        g.animatables = d;
                        g.type = l;
            ...
            var c = Math.min(Math.max(b - a.delay, 0), a.duration) / a.duration, d = a.to.numbers.map(function (b, d) {
                var e = a.from.numbers[d], f = C[a.easing](c, a.elasticity), e = a.path ? ca(a, f) : e + f * (b - e);
            ...
            for (var d = 0; d < a.tweens.length; d++) {
                ...
                for (var f = e.currentValue, l = 0; l < e.animatables.length; l++) {
                    var k = e.animatables[l], m = k.id, k = k.target, g = e.name;
                    switch (e.type) {
                        case "css":
                            k.style[g] = f;
                            break;
            ...
            if (c)for (d in x || (x = (v(document.body, "transform") ? "" : "-webkit-") + "transform"), c)a.animatables[d].target.style[x] = c[d].join(" ")
        }, P = function (a) {
            var b = {};
            ...
            var c = b.settings,
                d = [], e;
            for (e in a)if (!t.hasOwnProperty(e) && "targets" !== e) {
    ...
    k.remove = function (a) {
        ...
        for (var b = n.length - 1; 0 <= b; b--)for (var c = n[b], d = c.tweens, e = d.length - 1; 0 <= e; e--)for (var h =
